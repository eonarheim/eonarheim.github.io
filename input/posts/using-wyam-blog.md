...
![](images/using-wyam-blog/nav.png)

![](images/using-wyam-blog/nav-wyam.png)
...
![](images/using-wyam-blog/newpost.png)
...
![](images/using-wyam-blog/overridestheme.png)
...
![preview](images/using-wyam-blog/wyam-preview2.png)
...
![Folder ACLs](images/using-wyam-blog/iis-perms.PNG)
...
![extensionless](images/using-wyam-blog/url-non-rewrite.PNG)

Versus

![extension](images/using-wyam-blog/url-non-rewrite-html.PNG)
...
![rewrite-module](images/using-wyam-blog/download-rewrite.PNG)
...
```
![rewrite](images/using-wyam-blog/url-rewrite.PNG)
...
![appveyor](images/using-wyam-blog/appveyorlogin.PNG)

Find your GH pages repo and turn it on.

![appveyorrepo](images/using-wyam-blog/appveyoradd.PNG)
...
![appveyorsettings](images/using-wyam-blog/settings.PNG)
...
![master-only](images/using-wyam-blog/must-be-built.PNG)
...
![access_token](images/using-wyam-blog/accesstokenencryption.PNG)

This can be generated by logging into GitHub, and generating a "Personal Access Token", with `repo` scope.

![access token scope](images/using-wyam-blog/githubtokenscope.PNG)

Now AppVeyor builds commits to my origin `source` branch automagically! And Voila!
![build](images/using-wyam-blog/appveyorbuild.PNG)

Finished product!

![](images/using-wyam-blog/blogcomplete.PNG)
...
![dnsscan](images/using-wyam-blog/cloudflarescan.PNG)
...
![name server](images/using-wyam-blog/dnsimplenameservers.PNG)
...
![crypto](images/using-wyam-blog/cloudflare-crypto.PNG)
...
![san1](images/using-wyam-blog/san-cert.PNG)

![san2](images/using-wyam-blog/cloudflarescan2.PNG)
