/*! Excalibur - v0.2.0-alpha - 2014-03-09
        ...
        Actor.prototype.update = function (engine, delta) {
            ...
            engine.clicks.forEach(function (e) {
                if (_this.contains(e.x, e.y)) {
                    eventDispatcher.publish(ex.EventType[10 /* Click */], new ex.Click(e.x, e.y));
                    eventDispatcher.publish(ex.EventType[3 /* MouseDown */], new ex.MouseDown(e.x, e.y));
                }
            });

            engine.mouseMove.forEach(function (e) {
                if (_this.contains(e.x, e.y)) {
                    eventDispatcher.publish(ex.EventType[4 /* MouseMove */], new ex.MouseMove(e.x, e.y));
                }
            });

            engine.mouseUp.forEach(function (e) {
                if (_this.contains(e.x, e.y)) {
                    eventDispatcher.publish(ex.EventType[5 /* MouseUp */], new ex.MouseUp(e.x, e.y));
                }
            });
...
(function (ex) {
    ...
    var Engine = (function (_super) {
        ...
        function Engine(width, height, canvasElementId, displayMode) {
            ...
            this.logger = ex.Logger.getInstance();
            this.logger.addAppender(new ex.ConsoleAppender());
        ...
        Engine.prototype.initialize = function () {
            ...
            this.canvas.addEventListener('mousedown', function (e) {
                ...
                var mousedown = new ex.MouseDown(transformedPoint.x, transformedPoint.y);
            ...
            this.canvas.addEventListener('mousemove', function (e) {
                ...
                var y = e.pageY - ex.Util.getPosition(_this.canvas).y;
                var transformedPoint = _this.transformToCanvasCoordinates(x, y);
                var mousemove = new ex.MouseMove(transformedPoint.x, transformedPoint.y);
            ...
            this.canvas.addEventListener('mouseup', function (e) {
                ...
                var y = e.pageY - ex.Util.getPosition(_this.canvas).y;
                var transformedPoint = _this.transformToCanvasCoordinates(x, y);
                var mouseup = new ex.MouseUp(transformedPoint.x, transformedPoint.y);
...
//# sourceMappingURL=Excalibur-0.2.0-alpha.js.map
